<template>
  <div class="container">
    ...
    <table class="table mt-2">
      <thead>
        <tr class="table-primary">
          ...
          <th
            scope="col"
            class="table-info text-center align-middle"
      ...
      <tbody>
        <tr v-for="articulo in articulosPorPagina" :key="articulo.id">
          ...
          <td>
            <img
              :src="`http://localhost:5000/uploads/images/${articulo.imagen}`"
          ...
          <div v-if="isModalOpen" class="modal" @click="closeModal">
            <img
              :src="`http://localhost:5000/uploads/img/${articulo.imagen}`"
              alt="Foto expandida"
              class="modal-content"
            />
          </div>
    ...
    <div class="d-flex justify-content-center my-3">
      ...
      <button
        class="btn btn-primary"
        :disabled="currentPage * pageSize >= this.articulos.length"
