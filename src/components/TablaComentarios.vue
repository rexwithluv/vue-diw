<template>
      ...
      <form class="row m-auto gx-4 gy-3 border rounded bg-light pb-3">
        ...
        <div class="col-7">
          <div class="input-group">
            ...
            <input
              ...
              required
              disabled
              @blur="validarCorreo(this.comentario.email)"
        ...
        <div class="col-5">
          <div class="input-group">
            ...
            <input
              ...
              required
              disabled
              @blur="validarTelefono(this.comentario.movil)"
              v-model="comentario.movil"
            />
          </div>
        </div>
          ...
          <div class="input-group">
            ...
            <div class="form-control">
              <span
                ...
                :key="n"
                :class="
                  n <= this.comentario.valoracion
                    ? 'bi bi-star-fill'
                    : 'bi bi-star'
                "
                @click="setValoracion(n)"
                class="star-icon-pointer"
              ></span>
            </div>
          </div>
        </div>
        ...
        <div class="col-12">
          <button
            ...
            @click.prevent="guardarComentario()"
          >
  ...
  <div class="my-3 mx-2">
          ...
          <tr v-for="comentario in comentariosPorPagina" :key="comentario.id">
            ...
            <td class="align-middle text-center">
              <span
                ...
                :key="n"
                :class="
                  n <= comentario.valoracion ? 'bi bi-star-fill' : 'bi bi-star'
                "
                class="star-icon"
              ></span>
            </td>
            <td class="text-center align-middle pale-yellow" v-if="isAdmin">
              <div>
                <button
                  ...
                  @click.prevent="seleccionarComentario(comentario)"
                >
                  <i class="bi bi-pencil-fill"></i>
                </button>
                <button
                  class="btn btn-danger m-2"
                  @click.prevent="eliminarComentario(comentario)"
                >
    ...
    <div class="d-flex justify-content-center">
      ...
      <button
        class="btn btn-primary"
        :disabled="currentPage * pageSize >= comentarios.length"
