<template>
      ...
      <form class="row gy-3 pb-3 border rounded bg-light">
        ...
        <div class="col-6">
          <div class="input-group">
            ...
            <input
              ...
              @blur="validarCorreo(this.candidato.email)"
              required
            />
          </div>
        </div>
        <div class="col-6">
          <div class="input-group">
            ...
            <input
              ...
              @blur="validarTelefono(this.candidato.telefono)"
              required
            />
          </div>
        </div>
        ...
        <div class="col-lg-6 col-sm-7">
          <div class="input-group">
            ...
            <div class="btn-group form-control" role="group">
              ...
              />
              <label class="btn btn-outline-secondary" for="remoto"
                >Remoto</label
              >
              ...
              <input
                ...
                v-model="candidato.modalidad"
              />
              <label class="btn btn-outline-secondary" for="hibrido"
                >Híbrido</label
              >
              ...
              <input
                ...
                v-model="candidato.modalidad"
              />
              <label class="btn btn-outline-secondary" for="presencial"
                >Presencial</label
              >
            </div>
          </div>
        ...
        <div class="col-12">
          <button
            ...
            @click.prevent="guardarCandidato()"
          >
            Mandar CV
          </button>
        </div>
  ...
  <div class="my-3 mx-2" v-if="isAdmin">
          ...
          <tr v-for="candidato in candidatosPorPagina" :key="candidato.id">
            ...
            <td class="text-center align-middle pale-yellow">
              <button
                ...
                @click.prevent="seleccionarCandidato(candidato)"
              >
                <i class="bi bi-pencil-fill"></i>
              </button>
              <button
                class="btn btn-danger m-2"
                @click.prevent="eliminarCandidato(candidato)"
              >
    ...
    <div class="d-flex justify-content-center">
      ...
      <button
        class="btn btn-primary"
        :disabled="currentPage * pageSize >= candidatos.length"
